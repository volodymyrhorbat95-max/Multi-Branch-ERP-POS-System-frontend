...
import { MdStar, MdInventory, MdSearch, MdClose } from 'react-icons/md';
    ...
    >
      ...
      <div className="aspect-square bg-gray-100 dark:bg-gray-700 rounded-sm mb-3 flex items-center justify-center animate-fade-up duration-normal">
        {product.image_url ? (
          ...
          <MdInventory className="w-8 h-8 text-gray-400" />
        )}
      </div>
          ...
          rightIcon={
            searchQuery ? (
              <button onClick={() => onSearchChange('')}>
                <MdClose className="w-5 h-5 text-gray-400 hover:text-gray-600" />
              </button>
            ) : undefined
          }
        />
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500 animate-fade-up duration-normal">
            <MdInventory className="w-16 h-16 mb-4 opacity-50 animate-zoom-in duration-light-slow" />
            ...
            {showFeatured && (
              <div className="animate-fade-down duration-fast">
                <div className="flex items-center gap-2 mb-3">
                  <MdStar className="w-5 h-5 text-primary-500" />
